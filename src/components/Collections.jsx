...
const Collections = () => {
    return (
        <div className='h-screen lg:h-[70ch] flex flex-col justify-center lg:flex-row items-center bg-PrimaryColor mt-14 lg:px-32'>
            <div className='flex justify-center w-full lg:w-2/4 pt-6 ml-6 pb-6'>
                <img src={img} alt="img" />
            </div>
            ...
            <div className='w-full  lg:w-2/4 space-y-4pt-5 text-center lg:text-start'>
                ...
                <button className='bg-ExtraDarkColor mt-6 text-white px-4 py-2 font-medium active:bg-amber-800'>
                    Shop Now
                </button>
            </div>
        </div>
